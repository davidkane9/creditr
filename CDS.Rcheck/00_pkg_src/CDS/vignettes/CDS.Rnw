...
<<echo = FALSE>>=
    #    IR.DV.01(data.frame(date = "2014-04-22",
     #             currency = "USD",
      #            tenor = "5Y",
       #           spread = 160,
        #          coupon = 100,
...
<<echo = FALSE>>=
#default.prob(spread = 160, t = 5, recovery.rate = 0.4)
@
