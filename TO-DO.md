...
DONE: * What is going on with the dates in 2003 that have a 1M but not a 3Y. table(rates$expiry[rates$year %in% c(2003)])
...
DONE: * Drop the maturity slot? We should discuss this.
