...
#' 
#' @param data dataframe containing the 1. probability of default (pd) over a a 
#'   certain tenor period, 2. id and 3. spread
#' @param spread.var name of the column containing the spread
#' @param end.date.var name of the column containing the end dates or maturity 
#'   dates. This is when the contract expires and protection ends. Any default 
#'   after this date does not trigger a payment.
