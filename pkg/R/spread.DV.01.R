...
spread.DV.01 <- function(object = NULL,
                       TDate,
                       baseDate = TDate,
                       currency = "USD",
...
#' The spread.DV.01 method for CDS class.
#'
#' Calculate the \code{spread.DV.01} from conventional spread
#' 
#' @name spread.DV.01-method
#' @aliases spread.DV.01,CDS-method
#' @docType methods
#' @rdname spread.DV.01-methods
#' @param object the input \code{CDS} class object
#' @export


setMethod("spread.DV.01",
