...
Figure 2 above displays data on the CDS of Alcoa Inc on June 02, 2014 from Bloomberg. We can see many of the key variables that are used in a CDS contract between two counterparties:\footnote{Some of the
