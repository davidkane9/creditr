...
A \textbf{Credit Default Swap} (CDS) is type of credit derivative that has become increasingly popular among bondholders, investors, and companies. To exemplify the advantages to this economic tool, consider the following scenario:

Let's say that there exists a portfolio manager (that is, a person who manages mupltiple investments of several forms) who owns a \textbf{bond}--an agreement in which individuals and institutions lend money to companies and governments with the expectation that the debt is repaid at a specified date in the future. The manager's confidence in the credit worthiness of the company that issued the bond is beginning to waiver--in other words, the manager is worried that the company will \textbf{default} on its bonds (become unable to repay its debts to its bondholders) and that as a result, he will lose the money he lent. His concern could be due to a number of reasons: perhaps the company's credit rating recently decreased, or perhaps [give another example]. Either way, he wants to feel more secure about his investment. 

While the portfolio manager could just sell his bond and do away with any risk of losing money, he is reluctant to do so because that transcation may be too expensive or too cumbersome. Here is where a CDS comes in. A CDS is an agreement between two
\textbf{counterparties}, or opposing groups, in which the buyer--in this case, the portfolio manager--pays a \textbf{fixed periodic coupon} to the seller in exchange for protection in the case of a \textbf{credit event} associated with the buyer's bond. A credit event is a term that encompasses the risk of a company's bankruptcy and resulting default; depending on the CDS contract, however, a credit event can be expanded to include failure to pay out debt within a certain amount of time, substantial decrease in credit rating, confiscation of assets, and even effects of wars.
