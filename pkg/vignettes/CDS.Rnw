...
In April 2009 in North America, and June 2009 in Europe, CDS contracts were standardized such that dealers would have to quote fixed coupons of 100bp or 500bp in North America, or 25bp, 100bp, 500bp or 1000bp in Europe. The \textbf{Coupon} printed in the figure above is the fixed coupon for Alcoa Inc., which is 100bp or 1\% of the notional. However, the dealers may not feel that this is the fair premium for protection. The hedge fund selling protection to the portfolio manager may feel that the fair premium should be 160bp, and not 100bp. This fair premium rate is the \textbf{Trd Sprd} in the figure above, labelled as 160. 

Naturally, if the hedge fund believes that the fair premium should be 160bp, it would like to compensated for receiving just 100bp in advance. The portfolio manager would have to make what is known as an \textbf{Upfront Payment}, labelled as \textbf{Cash Amount} in Figure \ref{fig:CDSalcoa}. With the information for Alcoa given in the figure, this amount is  Therefore, the total payments made by the portfolio manager over the life of the contract would look like Figure \ref{fig:CDSnoevent}.
