...
For concreteness, we will start with a five year on-the-run Alcoa CDS. Assume that today is June 20, 2014 and we are pricing an Alcoa CDS with a \$10 million notional value that matures on September 20, 2019. The CDS pays a 100 bps coupon.
