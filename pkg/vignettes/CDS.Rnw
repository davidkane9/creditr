...
To exemplify the advantages and mechanics of  a CDS as a hedging tool, consider the following scenario:
Let's say that there exists a portfolio manager who possesses a certain amount of \textbf{assets}, or money, that he can invest. This portfolio manager decides to buy a \textbf{bond}--an agreement in which one party lends money to another party in exchange for that same sum of money, plus interest, at a future date--from Company A with a one-year \textbf{ maturity date}. So, in five years, Company A is expected to return the same sum of money that the portfolio manager lent. Company A also agrees to pay monthly \textbf{interest} to the portfolio manager at fixed dates described in the CDS that both parties signed. However, six months after buying the bond, the manager's confidence in the credit worthiness of Company A begins to waiver. In other words, the manager is worried that the company will \textbf{default} on its bonds (become unable to repay its debts to its bondholders) and that he will therefore lose the money he lent. Risks associated with the company's \textbf{credit rating}, as defined by rating agencies, or some other factor that may affect the company's credit risk, may encourage the manager to hedge his position and reduce his portfolio's exposure. Either way, the manager wants to feel more secure about his investment. To do this, the manager could adopt more convenitional techniques such as shorting of bonds or bond futures, holding put options. The portfolio manager could just sell his bond and do away with worrying about the bond's credit risk, he is reluctant to do so because that transcation is too expensive, or maybe just too cumbersome. 
...
A CDS is an agreement between two \textbf{counterparties}, or opposing groups, in which the buyer (in this case, the portfolio manager) pays a \textbf{fixed periodic coupon} to the seller in exchange for protection in the case of a \textbf{credit event} associated with the buyer's bond. A credit event is a term that encompasses the risk of a company's bankruptcy and resulting default; depending on the CDS contract, however, a credit event can be expanded to include failure to pay out debt within a certain amount of time, substantial decrease in credit rating, and confiscation of assets, among other events.

So, in this case, the manager does not have to choose between carrying the bond's credit risk and completing a transcation that would unecessarily cost him time or money. Instead, the manager can opt to buy protection in the form of a CDS, which would allow him to effectively transfer the credit risk to a third party who is willing to accept that risk for a fee. 

In our example, let's say that this third party is a hedge fund. So, the portfolio manager sends a periodic fee to a hedge fund, and in return, the hedge fund offers to pay a much larger sum to the portfolio manager in the case of company A's default. That way, the portfolio manager can pass on the bond's associated credit risk while still keeping the bond within his possession, and the hedge fund can receive a fee and possibly not have to pay anything in return (thus making a profit) if company A does not default. 

When the hedge fund agrees to this agreement, or when any \textbf{protection seller} offers to bear credit risk for a fee, that protection seller probably believes that the company or institution who borrowed money is somewhat credit-worthy, and will probably not go bankrupt and default. In our case, the hedge fund probably disagrees with the portfolio manager, and believes that company A will not default--otherwise (if the hedge fund believed that company A \emph{will} default), there would be no advantage to striking this kind of deal, as the hedge fund would more likely have a net loss of money than not! If company A does not default, the hedge fund can walk away with the money from the periodic fees and doesn't have to pay anything in return. 

If the portfolio manager agrees to become the \textbf{protection buyer} in this type of agreement, however, then this manager probably believes that there is a substantial chance that the company will default on its bonds, as the manager will end up with a net loss of money otherwise.

Let's assume that this particular bond did default. As such, the hedge fund ultimately had to compensate the portfolio manager for his loss in invesment. The exact amount or type of compensation would have been defined in the original CDS agreement, but for our purposes, let's assume that the compensation is equal to the total value of the bond minus the company's \textbf{recovery rate}. The recovery rate is defined as the amount that the company is able to give back to its debt holders after a credit event has happened. When a company goes into bankrupcty and is forced to default on its debt, whatever remains in the company's assets is paid out according to a \textbf{debt waterfall}. For example, a company's \textbf{debt} (bonds, bank loans, etc.) is paid out before its stock, and both stock and debt can be further categorized as "senior" and "junior", with with the former taking priority over the latter.

%% what's a CDS

A CDS is a simple and popular form of credit derivative. As described before, a single-name CDS contract provides a transfer of credit risk between two parties. The buyer of a CDS contract (protection buyer) transfers the credit risk to the CDS seller (protection seller) by paying a series of coupons until the contract terminates. In other words, the protection buyer is short credit by selling the credit risk of an underlying bond to the protection seller. 

The International Swaps and Derivatives Association (ISDA) has created a
...
As shown in Figure \ref{fig:cashFlow}, the buyer pays a stream of coupon payments, called
