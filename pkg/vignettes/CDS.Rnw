...
\author{Heidi Chen\thanks{\href{mailto:s.heidi.chen@gmail.com}{s.heidi.chen@gmail.com}}, Yuanchu Dang\thanks{\href{mailto:yuanchu.dang@williams.edu}{yuanchu.dang@williams.edu}}, David Kane\thanks{\href{mailto:dave.kane@gmail.com}{dave.kane@gmail.com}}, Yang Lu\thanks{\href{mailto:yang.lu2014@gmail.com}{yang.lu2014@gmail.com}}, \\ Kanishka Malik\thanks{\href{mailto:kanishkamalik@gmail.com}{kanishkamalik@gmail.com}}, Skylar Smith\thanks{\href{mailto:sws2@williams.edu}{sws2@williams.edu}}, and Zijie Zhu\thanks{\href{mailto:zijie.zhu@williams.edu}{zijie.zhu@williams.edu}}}
\maketitle
...
\begin{align}
  \rm \hspace{3pt}- \frac{C}{(1 + int_i)} * 20 + [ P * V * (1 - RR) ]  &= \rm \hspace{3pt}\frac{C}{(1 + int_i)} * 20 - [ P * V * (1 - RR) ] 
\end{align}

where $int$ stands for constant interest rate, $V$ stands for notional value, $RR$ stands for recovery rate, and C stands for coupon payment. If we specify that $V = 100,000$, $RR = 0.4$, and $C = 1000$, then we can easily calculate that $P = 33.333\% $ for the whole 20 periods.

If we continue to add complications of non-constant interest rate $int$, non-constant probability of default $P$, the above equation can be mathematically expressed as:

\begin{align}
  \rm \hspace{3pt}\frac{C}{(1 + int_i)} + [ P_i * V * (1 - RR) ]  &= \rm \hspace{3pt} \frac{C}{(1 + int_i)} - [ P_i * V * (1 - RR) ] 
\end{align}

where $i$ denotes different periods from one to twenty. Since the overall probability of default should sum to 33.333\%, we 
