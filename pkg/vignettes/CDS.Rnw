...
<<>>=
x <- data.frame(  dates = as.Date(cds1@TDate),
                  currency = cds1@currency,
                  tenor = cds1@tenor,
                  spread = cds1@parSpread,
                  maturity = cds1@maturity,
                  coupon = cds1@coupon,
                  recoveryRate = cds1@recoveryRate,
                  notional = cds1@notional)
cds1.CS10 <- CS10(x)
cds1.CS10
@ 
