...
\begin{align}
  \rm -\hspace{3pt}C + (P \times V)  &= \rm C - (P t\times V) \\
...
\begin{align}
  \rm \hspace{3pt}- \frac{C}{(1 + int)} \times 20 + [ P \times V \times (1 - RR) ]  &= \rm \hspace{3pt}\frac{C}{(1 + int)} \times 20 - [ P \times V \times (1 - RR) ] 
\end{align}
...
\begin{align}
  \rm \hspace{3pt}\frac{C}{(1 + int)} + [ P_i \times V \times (1 - RR) ]  &= \rm \hspace{3pt} \frac{C}{(1 + int)} - [ P_i \times V \times (1 - RR) ] 
\end{align}
