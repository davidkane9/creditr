...
The remaining three items from the \texttt{summary} output  are \texttt{Spread DV01}, \texttt{IR DV01}, and \texttt{Rec Risk (1 pct)}. In \texttt{cds1}, the Spread DV01 is \$4,667; the IR DV01 is \$-75.64; the Rec Risk (1 pct) is \$-330.19.
