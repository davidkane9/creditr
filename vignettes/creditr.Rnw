...
\begin{align}
   \rm Highbridge\hspace{3pt}PM's\hspace{3pt}expected\hspace{3pt}cash\hspace{3pt}flows &= -\$2,000 + (1-P_1)(\$100,000\times P_2) + P_1\times \$100,000\\
   \rm Citigroup's\hspace{3pt}expected\hspace{3pt}cash\hspace{3pt}flows &= \hspace{3pt}\$2,000 - (1-P_1)(\$100,000\times P_2) - P_1\times \$100,000
\end{align}

We now simplify and examine $P_1$ and $P_2$:
