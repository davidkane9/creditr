...
The following table shows an N-period CDS with a coupon of 1\% and a notional amount of \$100,000. A default occurs in the second year. This example builds off of \ref{table.4} and \ref{table.nonconstprob}, but includes some new aspects such roll dates, default, and accrued coupon:
...
Date & $CF_H$ & $CF_C$ & $P$ & $P_{cum}$ & Spread & $RR$ & $Accrued$ \\ 
  ...
  Jul 20, 2015 & \$99,667 & -\$99,667 & 3.75\% & -\$500 & 375 bps & 40\% & \$333 \\
   \hline
\end{tabular}
}
\caption{}
